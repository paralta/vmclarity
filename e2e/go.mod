...
require (
	...
	github.com/openclarity/vmclarity/testenv v0.7.0-rc.5
	github.com/openclarity/vmclarity/uibackend/client v0.7.0-rc.5
	github.com/openclarity/vmclarity/uibackend/types v0.7.0-rc.5
...
require (
	...
	github.com/openclarity/vmclarity/installation v0.7.0-rc.5 // indirect
	github.com/openclarity/vmclarity/utils v0.7.0-rc.5 // indirect
