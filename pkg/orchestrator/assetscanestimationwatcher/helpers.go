...
func (w *Watcher) getLatestAssetScanStats(ctx context.Context, asset *models.Asset) (models.AssetScanStats, error) {
	...
	if err != nil {
		logrus.Errorf("Failed to get asset scans for exploits. Ommiting stats")
	} else {
	...
	res, err = w.backend.GetAssetScans(ctx, params)
	if err != nil {
		logrus.Errorf("Failed to get asset scans for sbom. Ommiting stats")
	} else {
	...
	res, err = w.backend.GetAssetScans(ctx, params)
	if err != nil {
		logrus.Errorf("Failed to get asset scans for vulnerabilities. Ommiting stats")
	} else {
	...
	res, err = w.backend.GetAssetScans(ctx, params)
	if err != nil {
		logrus.Errorf("Failed to get asset scans for malware. Ommiting stats")
	} else {
	...
	res, err = w.backend.GetAssetScans(ctx, params)
	if err != nil {
		logrus.Errorf("Failed to get asset scans for misconfigurations. Ommiting stats")
	} else {
	...
	res, err = w.backend.GetAssetScans(ctx, params)
	if err != nil {
		logrus.Errorf("Failed to get asset scans for rootkits. Ommiting stats")
	} else {
	...
	res, err = w.backend.GetAssetScans(ctx, params)
	if err != nil {
		logrus.Errorf("Failed to get asset scans for secrets. Ommiting stats")
	} else {
