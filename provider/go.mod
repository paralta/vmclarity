...
require (
	...
	github.com/openclarity/vmclarity/containerruntimediscovery/client v0.7.0-rc.2
	github.com/openclarity/vmclarity/containerruntimediscovery/types v0.7.0-rc.2
...
require (
	...
	github.com/anchore/syft v0.105.1 // indirect
