...
require (
	...
	github.com/openclarity/vmclarity/api/client v0.7.0-rc.4
	github.com/openclarity/vmclarity/api/types v0.7.0-rc.4
	github.com/openclarity/vmclarity/cli v0.7.0-rc.4
	github.com/openclarity/vmclarity/core v0.7.0-rc.4
	github.com/openclarity/vmclarity/provider v0.7.0-rc.4
...
require (
	...
	github.com/openclarity/vmclarity/containerruntimediscovery/client v0.7.0-rc.4 // indirect
	github.com/openclarity/vmclarity/containerruntimediscovery/types v0.7.0-rc.4 // indirect
