...
//	newGetExistingError := func(err error) error {
//		return fmt.Errorf("failed to get existing asset scan %v: %w", assetScanEstimationID, err)
//	}
//
...
//	if err != nil {
//		return assetScanEstimation, newGetExistingError(err)
//	}
//
//	switch resp.StatusCode() {
//	case http.StatusOK:
//		if resp.JSON200 == nil {
//			return assetScanEstimation, newGetExistingError(fmt.Errorf("empty body"))
//		}
//		return *resp.JSON200, nil
//	case http.StatusNotFound:
//		if resp.JSON404 == nil {
//			return assetScanEstimation, newGetExistingError(fmt.Errorf("empty body on not found"))
//		}
//		if resp.JSON404 != nil && resp.JSON404.Message != nil {
//			return assetScanEstimation, newGetExistingError(fmt.Errorf("not found: %v", *resp.JSON404.Message))
//		}
//		return assetScanEstimation, newGetExistingError(fmt.Errorf("not found"))
//	default:
//		if resp.JSONDefault != nil && resp.JSONDefault.Message != nil {
//			return assetScanEstimation, newGetExistingError(fmt.Errorf("status code=%v: %v", resp.StatusCode(), *resp.JSONDefault.Message))
//		}
//		return assetScanEstimation, newGetExistingError(fmt.Errorf("status code=%v", resp.StatusCode()))
//	}
//}
