...
require (
	...
	github.com/openclarity/vmclarity/containerruntimediscovery/client v0.7.0-rc.5
	github.com/openclarity/vmclarity/containerruntimediscovery/types v0.7.0-rc.5
